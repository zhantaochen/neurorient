...
dir_chkpt           = os.makedirs(os.path.join(CONFIG.MISC.BASE_DIRECTORY, CONFIG.CHKPT.DIRECTORY), exist_ok=True)
...
# ...Logging
dir_log       = os.makedirs(os.path.join(CONFIG.MISC.BASE_DIRECTORY, CONFIG.LOGGING.DIRECTORY), exist_ok=True)
