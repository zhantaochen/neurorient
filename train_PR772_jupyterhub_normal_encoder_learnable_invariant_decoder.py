...
from neurorient.model_normal_encoder_learnable_invariant_decoder  import NeurOrientLightning
...
parser.add_argument('-fn', '--file_name', help="Data file", dest='file_name', type=str, default=None)
